...
- (void)viewDidLoad {
    ...
    motionEffectX.minimumRelativeValue = @-25;
    motionEffectX.maximumRelativeValue = @25;
    ...
    motionEffectY.minimumRelativeValue = @-25;
    motionEffectY.maximumRelativeValue = @25;
    ...
    [temperatureLabel addMotionEffect:motionEffectX];
    [temperatureLabel addMotionEffect:motionEffectY];
    ...
    [hiloLabel addMotionEffect:motionEffectX];
    [hiloLabel addMotionEffect:motionEffectY];
    ...
    [conditionsLabel addMotionEffect:motionEffectX];
    [conditionsLabel addMotionEffect:motionEffectY];
    ...
    [iconView addMotionEffect:motionEffectX];
    [iconView addMotionEffect:motionEffectY];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    //NSLog(@"SCROLL height: %.2f  position: %.2f   percent: %.2f", height, position, percent);
    // 3
